...
import { Play, Send, Terminal as TerminalIcon, Code2, BookOpen, AlertCircle, X } from "lucide-react";
      ...
      <div className="flex items-center justify-between px-6 py-3 border-b border-white/5 bg-[#111111]">
        <div className="flex items-center gap-4">
          <h1 className="text-xl font-black italic tracking-tighter uppercase">
            Problem <span className="text-[#FFC72C]">{id}</span>
          </h1>
          <div className="h-4 w-px bg-white/10" />
          <span className="bg-green-500/10 text-green-400 border border-green-500/20 px-2 py-0.5 rounded text-[10px] font-mono font-bold uppercase tracking-widest">
            Easy
          </span>
        </div>
            ...
            <div className="h-full border-r border-white/5 bg-[#111111] flex flex-col">
              <div className="p-6 overflow-y-auto flex-1 custom-scrollbar">
                <div className="space-y-6 text-sm text-white/70 leading-relaxed font-sans">
                  <section>
                    <h2 className="text-lg font-bold text-white mb-2">Two Sum</h2>
                    <p>
